...
constitutes harassment or victimization? To answer this, see our [Harassment Policy](https://github.com/CMihai99/python-projects/blob/main/docs/legal/Harassment.md)
and our [Sexual Harassment Policy](https://github.com/CMihai99/python-projects/blob/main/docs/legal/SexualHarassment.md).
...
forbidden by our [Terms of Use](https://github.com/CMihai99/python-projects/blob/main/docs/legal/TermsOfUse.md).
...
stakeholders or our business. Always follow our [Cybersecurity Policy](https://github.com/CMihai99/python-projects/blob/main/docs/legal/Cybersecurity.md), too.
...
we're all responsible for these Python projects' success, but also because slacking off
